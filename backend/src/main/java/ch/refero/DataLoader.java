...
public class DataLoader implements ApplicationRunner {
    ...
    public void CreateInjection(Referential ref1, Referential ref2) {
        ...
        inj.setRef_id(dest.id); // injection from bananas to tomatos, tomatos ref owns the injection
        inj.srcId = src.id;
